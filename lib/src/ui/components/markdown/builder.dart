...
abstract class MarkDownComponentBuilderDelegate extends MarkdownBuilderDelegate
{
...
class MarkdownComponentBuilder implements md.NodeVisitor {
    /// Creates an object that builds a [Widget] tree from parsed Markdown.
    MarkdownComponentBuilder({ this.delegate, this.styleSheet, this.imageDirectory });

    /// A delegate that controls how link and `pre` elements behave.
    final MarkDownComponentBuilderDelegate delegate;
    ...
    Widget _buildImage(String src) {
        ...
        if (uri.scheme == 'http' || uri.scheme == 'https') {
            child = new CachedNetworkImage(imageUrl: uri.toString(), width: width, height: height);
        } else {
        ...
        if(_imageHandlers.isNotEmpty) {
            ...
            child = new GestureDetector(child: child, onTap: recognizer.onTap);
        }
